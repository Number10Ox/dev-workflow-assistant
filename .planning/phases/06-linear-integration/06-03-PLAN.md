...
<task type="auto">
  <name>Task 3: Create external-id.js and bridge-client.js</name>
  <files>
    /Users/jedwards/workspace/JobPrep/DevEx/dev-workflow-assistant/src/linear/external-id.js
    /Users/jedwards/workspace/JobPrep/DevEx/dev-workflow-assistant/src/linear/bridge-client.js
  </files>
...
Should show: BridgeClient, BRIDGE_EXTENSION_IDS, LINEAR_PROVIDER_IDS
  ...
  <done>
external-id.js exports generateExternalId, parseExternalId, isValidExternalId. bridge-client.js exports BridgeClient class with initialize(), createIssue(), updateIssue(), queryByExternalId(), checkCapabilities().
  </done>
</task>
