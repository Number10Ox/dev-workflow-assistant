...
<task type="auto">
  ...
  <action>
Update registry.js RUNTIME_FIELDS to include the new Linear sync fields:
...
Add a helper function to update Linear fields:
...
```
  ...
  <done>
registry.js RUNTIME_FIELDS includes linear_issue_id, linear_identifier, linear_url, linear_external_id, linear_project_id, dwa_sync_hash. New updateLinearFields() function exported.
  </done>
</task>
...
<success_criteria>
- registry.js RUNTIME_FIELDS includes: linear_issue_id, linear_identifier, linear_url, linear_external_id, linear_project_id, dwa_sync_hash
